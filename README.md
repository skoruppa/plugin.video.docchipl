...
![Version](https://img.shields.io/badge/version-0.2.4.1-blue.svg)
...
2.  Download the latest version of the addon as a `.zip` file (e.g., `plugin.video.docchipl-0.2.4.1.zip`).
