...
def get_video_from_bigwarp_player(filelink: str):
    ...
    try:
        ...
        post_data = { 'op': 'embed', 'file_code': file_code, 'auto': '1', 'referer': filelink }
        headers_post = { "User-Agent": random_agent, "Referer": filelink, "Origin": "https://bigwarp.io", "Content-Type": "application/x-www-form-urlencoded" }
